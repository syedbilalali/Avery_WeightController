                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPendingRecordDeletion" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlTransactionDeletion" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlConfiguaration" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPasswordPolicy" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPasswordReset" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlRFIDIssue" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlDatabaseOperation" runat="server" CssClass="FilddHalf112" AppendDataBoundItems="false">
                                            <asp:ListItem Text="Disabled" Value="0"></asp:ListItem>
                                            <asp:ListItem Text="Enabled" Value="1"></asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
