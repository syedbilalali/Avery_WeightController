...
<ul>
<li><a href="javascript:void(0);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image5','','/images/Type5/wi_base_hover.png',1)"><asp:Image ID="Image5" runat="server" ImageUrl="" Width="90" Height="109" /></a></li>
<li><a href="javascript:void(0);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image6','','/images/Type5/wi_view_hover.png',1)"><asp:Image ID="Image6" runat="server" ImageUrl="" Width="90" Height="109" /></a></li>
<li><a href="javascript:void(0);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image7','','/images/Type5/wi_sense_hover.png',1)"><asp:Image ID="Image7" runat="server" ImageUrl="" Width="90" Height="109" /></a></li>
<li><a href="javascript:void(0);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image8','','/images/Type5/wi_tag_hover.png',1)"><asp:Image ID="Image8" runat="server" ImageUrl="" Width="90" Height="109" /></a></li>
<li><a href="javascript:void(0);" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image9','','/images/Type5/wi_connect_hover.png',1)"><asp:Image ID="Image9" runat="server" ImageUrl="" Width="90" Height="109" /></a></li>
</ul>
</div>
