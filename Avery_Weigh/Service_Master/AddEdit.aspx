                        ...
                        <div class="RightInnMasters">
                            ...
                            <table border="0" cellspacing="0" cellpadding="2">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlamctype" runat="server" CssClass="FilddHalf112" Width="287px">
                                            <asp:ListItem Value="">Select</asp:ListItem>
                                            <asp:ListItem Value="Silver(No Spares)">Silver(No Spares)</asp:ListItem>
                                            <asp:ListItem Value="Gold(Without Load Cells)">Gold(Wihout Load Cells)</asp:ListItem>
                                            <asp:ListItem Value="Platinum(All Spares)">Platinum(All Spares)</asp:ListItem>
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right" width="150px;">Warrantee</td>
                                    <td>
                                         <asp:DropDownList ID="ddlWarrantee" runat="server" CssClass="FilddHalf112" Width="287px">
                                            <asp:ListItem Value="">Select</asp:ListItem>
                               ...
                               <tr>
                                    <td align="right" width="150px;">Garrantee</td>
                                    <td>
                                         <asp:DropDownList ID="ddlGarrantee" runat="server" CssClass="FilddHalf112" Width="287px">
                                            <asp:ListItem Value="">Select</asp:ListItem>
                                            <asp:ListItem Value="Yes">Yes</asp:ListItem>
                                            <asp:ListItem Value="No">No</asp:ListItem>
